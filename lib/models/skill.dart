...
final List<Skill> allSkills = [
  // algo wizard skills
  Skill(id: '1', name: 'Brute Force Bolt', image: 'bf_bolt.jpg', vocation: Vocation.algorithmic),
  Skill(id: '2', name: 'Recursive Wave', image: 'r_wave.jpg', vocation: Vocation.algorithmic),
  Skill(id: '3', name: 'Hash Beam', image: 'h_beam.jpg', vocation: Vocation.algorithmic),
  Skill(id: '4', name: 'Backtrack', image: 'backtrack.jpg', vocation: Vocation.algorithmic),
